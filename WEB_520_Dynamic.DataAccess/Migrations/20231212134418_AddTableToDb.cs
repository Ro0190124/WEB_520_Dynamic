    ...
    public partial class AddTableToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBienLaiChiTiet = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaBienLai = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BIEN_LAI_CHI_TIETs", x => x.MaBienLaiChiTiet);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BIEN_LAI_CHI_TIETMaBienLaiChiTiet = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LOs", x => x.MaLo);
                    table.ForeignKey(
                        name: "FK_LOs_BIEN_LAI_CHI_TIETs_BIEN_LAI_CHI_TIETMaBienLaiChiTiet",
                        column: x => x.BIEN_LAI_CHI_TIETMaBienLaiChiTiet,
                        principalTable: "BIEN_LAI_CHI_TIETs",
                        principalColumn: "MaBienLaiChiTiet");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LOs_BIEN_LAI_CHI_TIETMaBienLaiChiTiet",
                table: "LOs",
                column: "BIEN_LAI_CHI_TIETMaBienLaiChiTiet");
